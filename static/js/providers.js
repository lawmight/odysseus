...
const _PROVIDERS = [
  // Cursor
  [/cursor|composer-/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h10.5L20 9.5V20H9.5L4 14.5zm2 2v7.7L10.3 18H18v-7.7L13.7 6zm4.1 4.1 3.8 3.8-1.4 1.4-3.8-3.8zm4.2-.8 1.4 1.4-5 5-1.4-1.4z"/></svg>'],
